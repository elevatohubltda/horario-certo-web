        ...
        <div className="user-dropdown">
          ...
          {mobile ? 
            <>
              ...
              <div className="dropdown-item" onClick={() => handleNavigate('/relatorios')}>
                <button>Relatórios</button>
              </div>
              <div className="dropdown-item" onClick={() => handleNavigate('/lista-de-espera')}>
              ...
              <div className="dropdown-item" onClick={() => handleNavigate('/divulgacao')}>
                <button>Divulgação</button>
              </div>
              <div className="dropdown-item" onClick={() => handleNavigate('/ajuda')}>
                <button>Ajuda</button>
              </div>
              <div className="dropdown-item" onClick={() => { setShareDialogOpen(true); setOpen(false); }}>
                <button>Link compartilhável</button>
