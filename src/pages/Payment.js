...
const PaymentProps = {
    ...
    date_of_expiration: "2026-01-11T19:17:40.570-04:00",
    pixCopyPaste:
...
function Payment() {
  ...
  const isPaid = PaymentProps.status === "paid";

  const getRemainingTime = () => {
    const target = new Date(PaymentProps.date_of_expiration).getTime();
        ...
        <>
          ...
          <InfoGrid>
            ...
            <div>
                ...
                <br />
                {new Date(PaymentProps.paymentDate).toLocaleDateString('pt-BR')}
            </div>
            <div>
              <strong>Próximo vencimento</strong>
              <br />
              {new Date(PaymentProps.nextDueDate).toLocaleDateString('pt-BR')}
            </div>
          </InfoGrid>
