...
import { getPaymentStatus } from "../services/endpoints/payment";
...
function Payment() {
  ...
  const getPayment = async () => {
    try {
      var response = await getPaymentStatus(companyUrl);
        ...
        <>
          ...
          {!isPaid ? (
            <>
              ...
              {paymentProps.features.length > 0 &&
                <>
                    ...
                    {paymentProps.features.map((item, index) => (
                      <div
                        ...
                        style={{
                            ...
                            gap: "0.5rem",
                            padding: "0.35rem 0",
                            borderBottom: index !== paymentProps.features.length - 1 ? "1px solid #e5e7eb" : "none",
                        }}
                      >
                        <span
                            style={{
